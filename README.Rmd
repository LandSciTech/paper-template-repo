...
Launch the [`make.R`](https://github.com/LandSciTech/CaribouDemographyQuebecPaper/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/LandSciTech/CaribouDemographyQuebecPaper/blob/main/CONTRIBUTING.md).
